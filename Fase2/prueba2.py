...
print("CREATE DATABASE: (áéíóú)",f.createDatabase("hlá","json","utf8"),"/ 0")
...
print("ALTER DATABASE: ",f.alterDatabase('hlá','editPrueba1'),"/ 0")
...
print("TABLE DECOMPRESS: ",f.alterTableDecompress('BD1','Periodo'),"/ 4")
print(f.extractTable("BD1","Periodo"), "\n")
...
print("", f.alterTableAddFK("BD1","Year", "index", [0], "Periodo", [0]), "/ 0")
print("", f.alterTableAddFK("BD1","Year", "index2", [0], "Periodo", [0]), "/ 0")
print("", f.alterTableDropFK("BD1","Periodo", "index"), "/ 4")
final = time.time()
print("------------------------------------------------------------------")
