...
print(f.alterDatabaseMode("BD4","hash"),'esperando 4')
print(f.alterDatabaseMode("BD4","b"),'esperando 0')
print(f.alterDatabaseMode("BD4","bplus"),'esperando 0')
print(f.alterDatabaseMode("BD2","hash"),'esperando 4')
...
print(f.alterDatabaseMode("BD3","avl"),'esperando 0')
print(f.alterDatabaseMode("BD3","hash"),'esperando 0')
print(f.alterTableMode("BD2","Asignacion_Curso","hash"),'esperando 3')
print(f.alterTableMode("BD2","Cliente","hash"),'esperando 0')
print(f.alterTableMode("BD2","Factura","bplus"),'esperando 4')
