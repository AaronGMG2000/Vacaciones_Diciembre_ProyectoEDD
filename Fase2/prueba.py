...
print(f"Compresion {f.alterTableCompress('BD3','Usuario',2)}")
...
print(f.createTable("prueba11","seguridad2",1),'esperando 0')
print(f.createTable("prueba11","seguridad3",1),'esperando 0')
print(f.createTable("prueba11","seguridad4",1),'esperando 0')
print(f.createTable("prueba11","seguridad5",1),'esperando 0')
print(f.createTable("prueba11","seguridad6",1),'esperando 0')
print(f.createTable("prueba11","seguridad7",1),'esperando 0')
print(f.createTable("prueba11","seguridad8",1),'esperando 0')
print(f.createTable("prueba11","seguridad9",1),'esperando 0')
print(f.createTable("prueba11","seguridad10",1),'esperando 0')
print(f.createTable("prueba11","seguridad11",1),'esperando 0')
print(f.createTable("prueba11","seguridad12",1),'esperando 0')
print(f.alterAddPK("prueba11","seguridad",[0,1]),'esperando 0')
print(f.alterAddPK("prueba11","seguridad2",[0]),'esperando 0')
print(f.safeModeOn("prueba11","seguridad"),'esperando 0')
print(f.alterTableCompress("prueba11","seguridad",3),'esperando 0')
...
print(f.alterDatabaseEncoding("prueba11","iso-8859-1"), 'esperando 0')
print(f.extractTable("prueba11","seguridad"))
print(f.alterDatabaseEncoding("prueba11","utf8"), 'esperando 0')
print(f.extractTable("BD1","Periodo"))
print(f"Compresion {f.alterDatabaseCompress('BD1',2)}")
print(f.extractTable("BD1","Periodo"))
print(f"Decompresion {f.alterDatabaseDecompress('BD1')}")
print(f.alterTableAddFK("prueba11","seguridad","index",[0],'seguridad2',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad","index1",[0],'seguridad3',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad2","index2",[0],'seguridad4',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad3","index3",[0],'seguridad5',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad5","index4",[0],'seguridad6',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad3","index5",[0],'seguridad6',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad8","index6",[0],'seguridad7',[0]),'esperando 0')
print(f.alterTableAddFK("prueba11","seguridad9","index7",[0],'seguridad10',[0]),'esperando 0')
...
print(f.createDatabase("prueba13","bplus","utf8"),"esperado 0")
print(f.createTable("prueba13","seguridad",9),'esperando 0')
print(f.alterAddPK("prueba13","seguridad",[0,2,3])) 
print(f.alterTableAddUnique("prueba13","seguridad","index1",[1,4,5]),'esperando 0')
...
print(f.alterTableAddIndex("prueba11","seguridad","index1",[1]),'esperando 0')
print(f.alterTableAddIndex("prueba11","seguridad","index1",[1]),'esperando 1')
print(f.alterTableDropIndex("prueba11","seguridad","index1"),'esperando 0')
print(f.alterTableDropIndex("prueba11","seguridad","index1"),'esperando 4')
print(f.alterTableDropUnique("prueba11","seguridad","index1"),'esperando 0')
print(f.alterTableDropUnique("prueba11","seguridad","index1"),'esperando 4')
print(f.alterTableDropFK("prueba11","seguridad","index1"),'esperando 0')
print(f.alterTableDropFK("prueba11","seguridad","index1"),'esperando 4')
print(f.alterTableAddFK("prueba11","seguridad","index1",[0],'seguridad3',[0]),'esperando 0')
print(f.extractTable("BD1","Periodo"))
# print(f.dropDatabase("BD1"), 'esperando 0')
print(f.extractTable("BD2","Cliente"))
print(f.alterTable("BD2","Cliente","DB2"))
print(f.extractTable("prueba11","seguridad"))
print(f.delete("prueba11","seguridad",['Prueba2','2']),'esperando 0')
print(f.alterDatabase("BD2","DB2"))
print(f.extractTable("DB2","DB2"))
print(f.graphDSD("prueba11"))
print(f.graphDF("prueba13",'seguridad'))
basesDatos = f.showDatabases()
print("***********************************************")
for d in basesDatos:
    print(d)
# print(f.extractTable("BD2","Cliente"))
