...
print("CREAR BD:", j.createDatabase("CALIFICAION","json","utf8"), "Esperado:",0)
print("CREAR BD:", j.createDatabase("CALIFICAION","json","utf8"), "Esperado:",2)
...
print("CREAR BD:", j.createDatabase("calificacion","json","utf8"), "Esperado:",0)
